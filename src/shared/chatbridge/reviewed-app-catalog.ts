      ...
      manifest: {
        ...
        permissions: [
          ...
          },
          {
            ...
            access: 'read',
            required: true,
            purpose: 'Reopen app-managed Flashcard Studio study sheets through the host-owned Google Sheets connector.',
          },
          {
            id: 'sheets.write',
            resource: 'google-sheets',
            access: 'write',
            required: true,
            purpose: 'Save Flashcard Studio deck progress into a host-owned Google Sheet.',
          },
        ],
        toolSchemas: [
          {
