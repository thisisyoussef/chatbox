...
Sources: `src/shared/chatbridge/observability.ts`, `src/main/chatbridge/`, `src/shared/chatbridge/registry.ts`
...
- Likely surface: `src/shared/chatbridge/observability.ts`
