...
Sources: `src/shared/types/session.ts`, `src/renderer/routes/session/$sessionId.tsx`, `src/renderer/lib/format-chat.tsx`
...
- Likely surface: `src/renderer/routes/session/$sessionId.tsx`
- Likely surface: `src/renderer/lib/format-chat.tsx`
- Likely surface: `src/renderer/stores/sessionHelpers`
