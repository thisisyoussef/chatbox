...
Sources: `src/shared/types/session.ts`, `src/shared/utils/message.ts`, `src/renderer/components/chat/Message.tsx`
...
- Likely surface: `src/shared/utils/message.ts`
