...
Sources: `test/integration/`, `src/__tests__/`, `session helper utilities and formatters`
...
- Likely surface: `test/integration/`
- Likely surface: `src/__tests__/`
- Likely surface: `session helper utilities and formatters`
