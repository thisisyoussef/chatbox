...
Sources: `src/renderer/packages/model-calls/stream-text.ts`, `src/shared/models/abstract-ai-sdk.ts`, `src/shared/chatbridge/tools.ts`
...
- Likely surface: `src/shared/models/abstract-ai-sdk.ts`
- Likely surface: `src/shared/chatbridge/tools.ts`
