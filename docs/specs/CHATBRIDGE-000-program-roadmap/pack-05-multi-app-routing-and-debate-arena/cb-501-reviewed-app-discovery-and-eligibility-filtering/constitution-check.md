...
Sources: `src/shared/chatbridge/registry.ts`, `src/shared/chatbridge/policy.ts`, `src/renderer/packages/chatbridge/router/`
...
- Likely surface: `src/shared/chatbridge/registry.ts`
- Likely surface: `src/shared/chatbridge/policy.ts`
