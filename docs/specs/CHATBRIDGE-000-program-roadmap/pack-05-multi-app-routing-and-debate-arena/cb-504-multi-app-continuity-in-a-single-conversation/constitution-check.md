...
Sources: `src/renderer/packages/chatbridge/`, `src/renderer/packages/context-management/`, `src/shared/chatbridge/instance.ts`
...
- Likely surface: `src/shared/chatbridge/instance.ts`
